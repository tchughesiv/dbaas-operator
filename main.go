...
func main() {
	...
	if DBaaSReconciler.InstallNamespace, err = controllers.GetInstallNamespace(); err != nil {
		setupLog.Error(err, "unable to retrieve install namespace. default Config object cannot be installed")
	}
	...
	if err = (&controllers.DBaaSDefaultConfigReconciler{
		DBaaSReconciler: DBaaSReconciler,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "DBaaSDefaultConfig")
		os.Exit(1)
	}
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		...
		if err = (&v1alpha1.DBaaSConfig{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "DBaaSConfig")
			os.Exit(1)
		}
	}
	if err = (&controllers.DBaaSConfigReconciler{
		DBaaSReconciler: DBaaSReconciler,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "DBaaSConfig")
		os.Exit(1)
	}
