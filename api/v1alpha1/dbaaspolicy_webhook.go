...
func (r *DBaaSPolicy) ValidateCreate() error {
	...
	return validatePolicy(r, nil)
}

// ValidateUpdate implements webhook.Validator so a webhook will be registered for the type
func (r *DBaaSPolicy) ValidateUpdate(old runtime.Object) error {
	dbaaspolicylog.Info("validate update", "name", r.Name)
	return validatePolicy(r, old.(*DBaaSPolicy))
}
...
func validatePolicy(inv *DBaaSPolicy, oldInv *DBaaSPolicy) error {
	// Check ns selector
