...
// check if provisioning is allowed against an inventory. inventory takes precedence over dbaasconfig.
func canProvision(inventory v1alpha1.DBaaSInventory, activeConfig *v1alpha1.DBaaSConfig) bool {
	if activeConfig == nil {
		...
		if activeConfig.Spec.DisableProvisions != nil {
			return !*activeConfig.Spec.DisableProvisions
		}
	}
	return true
}
...
func (r *DBaaSReconciler) checkInventory(inventoryRef v1alpha1.NamespacedName, DBaaSObject client.Object,
	...
	provision = canProvision(*inventory, getActiveConfig(configList))
